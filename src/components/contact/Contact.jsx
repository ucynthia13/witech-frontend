    ...
    <div className='container text-font mt-5 mb-1 pt-5' id='contact'>
        <div className='row'>
            <div className='col-12 text-center'>
                <p className='fw-bold h3'> Help The Younger Generation<span className='d-block mt-3 heading-color '><span className='underlined'>Step Into The Future?</span></span>
                </p>
                <button className='btn btn-outline-secondary px-5 py-3 mt-5 button-background'>Donate</button>
            </div>
                ...
                <div className='row my-5'>
                    <div className='col-4 '>
                        ...
                        <div className='d-flex'>
                            <input className='form-control form-control-lg me-1 team-font-size' placeholder='Enter Your Email...'></input>
